...
let USERS_DB: User[] = [
  {
    ...
    password: 'racing2023',
    isActive: true,
    curso: { name: 'Angular', id: 2030, description: '', img: '' },
    role: 'Alumno',
  },
  {
    id: 2,
    ...
    password: 'mateo2022',
    isActive: true,
    curso: { name: 'ReactJS', id: 2040, description: '', img: '' },
    role: 'Alumno',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    password: '12345678',
    isActive: true,
    curso: { name: 'ReactJS', id: 2030, description: '', img: '' },
    role: 'Alumno',
  },
  {
    id: 5,
    ...
    password: 'racing2023',
    curso: { id: 2030, name: 'Angular', description: '', img: '' },
    isActive: true,
    role: 'Profesor',
  },
  {
    ...
    password: 'mateo2022',
    curso: { id: 2040, name: 'ReactJS', description: '', img: '' },
    isActive: true,
    role: 'Profesor',
  },
  {
    ...
    password: 'juegosonline',
    curso: { id: 3030, name: 'Matemáticas II', description: '', img: '' },
    isActive: false,
    role: 'Profesor',
  },
];
